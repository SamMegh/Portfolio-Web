        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="w-32 h-1.5 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 rounded-full mb-6"></div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 p-8 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {submitStatus === "success" && (
                  <div className="text-green-400 text-center font-medium bg-green-500/10 border border-green-500/20 rounded-xl p-3">
